...
public class IOCommandObject implements SubjectIOCommandObject, SubjectCLWorkDir{
	...
	private List<ObserverCLWorkDir> registeredCLWorkDirObservers = new LinkedList<ObserverCLWorkDir>();
	...
	@Override
	public void registerObserverCLWorkDir(ObserverCLWorkDir obs) {
		registeredCLWorkDirObservers.add(obs);
		
	}

	@Override
	public void removeObserverCLWorkDir(ObserverCLWorkDir obs) {
		registeredCLWorkDirObservers.remove(obs);
		
	}

	@Override
	public void notifyObserversCLWorkDir() {
		for(ObserverCLWorkDir obs : registeredCLWorkDirObservers)
		{
			obs.updateCLWorkDir();
		}
